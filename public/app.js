// ============================================
// eTalk — Bulletproof Video Call
// Fixes: Local video missing, tablet squeeze, echo feedback,
//        layout overlap, aggressive audio suppression
// ============================================
...
// ============================================
// ECHO DETECTION & FEEDBACK SUPPRESSION
// ============================================
...
function triggerFeedbackMute() {
  ...
  showEchoToast();
  console.warn('Feedback detected! Mic auto-muted.');
...
// ============================================
// ENTER CALL — CRITICAL FIX: Set localVideo srcObject
// ============================================
function enterCallScreen() {
  showScreen('call');
  isInCall = true;
  
  // FIX: localVideo was never getting srcObject set!
  if (localStream && localVideo) {
    localVideo.srcObject = localStream;
  }
  
  // Show recording dot if video is on
  if (localRecDot) {
